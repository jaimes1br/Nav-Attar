...
public class serviciosUsuarios {
    ...
    public serviciosUsuarios (){
        ...
        lista.add(new usuarios(5, "Mario oreno","cantinfleando@hotmail.com","1111155555","Cantinflas", 2));
    }
    ...
    public usuarios getUsuario(Long idUsuarios){
        ...
        return new usuarios(0, "No existe", "No existe", "No existe", "No existe", 0);
    }//getUsuario
    ...
    public void updateUsuario(Long idUsuario, String contrasenaOriginal, String nuevaContrasena, String nuevoNombre, String nuevoTelefono){
        if (idUsuario<= lista.size()){
            usuarios usuario = lista.get((idUsuario.intValue()-1));
