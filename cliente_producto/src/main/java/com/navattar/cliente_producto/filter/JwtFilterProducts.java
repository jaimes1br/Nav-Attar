...
public class JwtFilterProducts extends GenericFilterBean {
    ...
    public void doFilter(ServletRequest request,
        ...
        if (    (httpServletRequest.getMethod().equals("POST")) ||
            ...
            if  ( (authHeader== null ) || (! authHeader.startsWith("Bearer ")) ) {
                throw new ServletException("1. Invalid Token Productos!");
            } // == null ! Bearer
            ...
            try  {
                ...
                throw new ServletException( "2. Invalid Token! Productos" );
            }//catch
        }//POST - PUT - DELETE - GET
